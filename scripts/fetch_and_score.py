...

{
  ...
  "intro_zh": "产品卡片简介（30-50字），用大白话、像跟朋友聊天一样说清楚：第一句——这玩意儿干嘛的，第二句——什么人会需要它、为什么。禁止使用"该产品""它帮助""面向"这类僵硬表述，要自然有温度。示例："在Mac上装了个过目不忘的记忆助手，看到啥都能帮你记住、随时搜回来。经常忘事、记不住承诺的上班族和学生党必备。"",
  "scores": {
    "video_suitability": {
      "score": <1-5整数>,
